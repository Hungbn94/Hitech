...
Route::get('customers/GetCustomerByID/{CustomerID}', [CustomerController::class, 'GetCustomerByID']);
...
Route::get('properties/GetPropertyByID/{PropertiesID}', [PropertyController::class, 'GetPropertyByID']);
